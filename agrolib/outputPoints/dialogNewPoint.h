...
class DialogNewPoint : public QDialog
{
     Q_OBJECT
public:
    DialogNewPoint(const QList<QString>& _idList, const gis::Crit3DGisSettings& _gisSettings,
...
private:
    ...
    void computeLatLonFromUTM();
    void getHeightFromDEM();
    void setlatLon(double myLat, double myLon);
};
