...
PointStatisticsCallout::PointStatisticsCallout(QChart *chart):
    QGraphicsItem(chart),
    m_chart(chart)
{
    m_series = nullptr;
...
QRectF PointStatisticsCallout::boundingRect() const
{
    QPointF anchor;
    if (m_series != nullptr)
    {
...
void PointStatisticsCallout::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    Q_UNUSED(option)
    Q_UNUSED(widget)
    QPainterPath path;
...
void PointStatisticsCallout::mousePressEvent(QGraphicsSceneMouseEvent *event)
{
    event->setAccepted(true);
}

void PointStatisticsCallout::mouseMoveEvent(QGraphicsSceneMouseEvent *event)
{
...
void PointStatisticsCallout::setSeries(QAbstractSeries *series)
{
    m_series = series;
}

void PointStatisticsCallout::setText(const QString &text)
{
    m_text = text;
...
void PointStatisticsCallout::setAnchor(QPointF point)
{
    m_anchor = point;
}

void PointStatisticsCallout::updateGeometry()
{
    prepareGeometryChange();
    if (m_series != nullptr)
    {
