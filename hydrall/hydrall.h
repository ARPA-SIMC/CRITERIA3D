...
#define HYDRALL_H
    ...
    */
    ...
    public:
        ...
        void setSoilVariables(int nrLayers, int iLayer, int currentNode, float checkFlag, int horizonIndex, double waterContent, double waterContentFC, double waterContentWP, int firstRootLayer, int lastRootLayer, double rootDensity);
