...
#define GIS_H
    ...
    namespace gis
    {
        ...
        void getRowColFromXY(const Crit3DRasterGrid &rasterGrid, double myX, double myY, int* row, int* col);
        ...
        void getUtmXYFromRowCol(const Crit3DRasterGrid& rasterGrid, int myRow, int myCol ,double* myX, double* myY);
