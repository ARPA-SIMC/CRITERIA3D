...
#define EISPACK_H
    ...
    namespace eigenproblem {
        ...
        void cbabk2 ( int n, int low, int igh, double scale[], int m, double zr[], double zi[] );
        ...
        int cg ( int n, double ar[], double ai[], double wr[], double wi[], bool matz, double zr[], double zi[] );
        int ch ( int n, double ar[], double ai[], double w[], bool matz, double zr[], double zi[] );
        int ch3 ( int n, double a[], double w[], bool matz, double zr[], double zi[] );
        int cinvit ( int n, double ar[], double ai[], double wr[], double wi[], bool select[],
                     int mm, int *m, double zr[], double zi[] );
        void combak ( int n, int low, int igh, double ar[], double ai[], int inter[], int m, double zr[], double zi[] );
        void comhes ( int n, int low, int igh, double ar[], double ai[], int inter[] );
        int comlr ( int n, int low, int igh, double hr[], double hi[], double wr[], double wi[] );
        int comlr2 ( int n, int low, int igh, int inter[], double hr[], double hi[], double wr[],
                     double wi[], double zr[], double zi[] );
        int comqr ( int n, int low, int igh, double hr[], double hi[], double wr[], double wi[] );
        int comqr2 ( int n, int low, int igh, double ortr[], double orti[], double hr[], double hi[],
        ...
        void corth ( int n, int low, int igh, double ar[], double ai[], double ortr[], double orti[] );
        ...
        int hqr2 ( int n, int low, int igh, double h[], double wr[], double wi[], double z[] );
        void htrib3 ( int n, double a[], double tau[], int m, double zr[], double zi[] );
        void htribk ( int n, double ar[], double ai[], double tau[], int m, double zr[], double zi[] );
        void htrid3 ( int n, double a[], double d[], double e[], double e2[], double tau[] );
        void htridi ( int n, double ar[], double ai[], double d[], double e[], double e2[], double tau[] );
        ...
        int invit ( int n, double a[], double wr[], double wi[], bool select[], int mm, int *m, double z[] );
        int minfit ( int nm, int m, int n, double a[], double w[], int ip, double b[] );
        void ortbak ( int n, int low, int igh, double a[], double ort[], int m, double z[] );
        ...
        int ratqr ( int n, double eps1, double d[], double e[], double e2[], int m, double w[], int ind[], double bd[], bool type, int idef );
        ...
        int rg ( int n, double a[], double wr[], double wi[], bool matz, double z[] );
        ...
        int rspp ( int n, int nv, double a[], double w[], bool matz, double z[], int m, bool type );
        int rst ( int n, double w[], double e[], bool matz, double z[] );
        int rt ( int n, double a[], double w[], bool matz, double z[] );
        int svd ( int m, int n, double a[], double w[], bool matu, double u[], bool matv, double v[] );
        int tinvit ( int n, double d[], double e[], double e2[], int m, double w[], int ind[], double z[] );
        ...
        int tsturm ( int n, double eps1, double d[], double e[], double e2[],
                     double lb, double ub, int mm, int *m, double w[], double z[] );
